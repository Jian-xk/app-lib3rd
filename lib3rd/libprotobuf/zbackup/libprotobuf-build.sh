...
# build
build_options="-DCMAKE_INSTALL_PREFIX=$build_tmpdir/install -Dprotobuf_BUILD_SHARED_LIBS=ON -Dprotobuf_BUILD_TESTS=OFF -Dprotobuf_BUILD_TESTS=OFF"
...
cmake ../cmake $build_options
make
make install

# ==========NOTE==========
# delete set(protobuf_DEBUG_POSTFIX "d" CACHE STRING "Default debug postfix")
