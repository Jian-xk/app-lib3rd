...
#define SDL_VIDEO_DRIVER_KMSDRM_DYNAMIC_GBM "libmali-midgard-t86x-r14p0-wayland.so"

#define SDL_VIDEO_DRIVER_WAYLAND_QT_TOUCH 1
#define SDL_VIDEO_DRIVER_WAYLAND_DYNAMIC "libwayland-client.so.0"
#define SDL_VIDEO_DRIVER_WAYLAND_DYNAMIC_EGL "libmali-midgard-t86x-r14p0-wayland.so"
